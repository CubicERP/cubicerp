...
class account_model(osv.osv):
    ...
    def generate(self, cr, uid, ids, data=None, context=None):
        ...
        for model in self.browse(cr, uid, ids, context=context):
            ...
            move_id = account_move_obj.create(cr, uid, self._get_move_dict(cr, uid, entry, period_id, model, context=ctx))
            ...
            for line in model.lines_id:
                ...
                account_move_line_obj.create(cr, uid, self._get_move_line_dict(cr, uid, line, model, move_id, period_id, analytic_account_id, context=ctx), context=ctx)

        return move_ids

    def _get_move_line_dict(self, cr, uid, line, model, move_id, period_id, analytic_account_id, context=None):
    ...
    def _get_move_dict(self, cr, uid, entry, period_id, model, context=None):
        return {
                'ref': entry['name'],
                'period_id': period_id,
                'journal_id': model.journal_id.id,
