    ...
    def compute_refund(self, mode='refund'):
        ...
        for form in self:
            ...
            for inv in inv_obj.browse(context.get('active_ids')):
                ...
                related_journal = inv.journal_id.get_related_journal()
                refund = inv.refund(form.date_invoice, date, description, related_journal and related_journal.id or inv.journal_id.id)
