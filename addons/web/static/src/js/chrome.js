...
(function () {
        ...
        _add_buttons: function (buttons) {
            ...
            _.each(buttons, function (fn, text) {
                ...
                var $but = $(QWeb.render('WidgetButton', {
                    widget: {
                        string: text,
                        node: {attrs: {'class': oe_link_class}}
                    }
                }));
        ...
        rpc_error: function (error) {
            ...
            if (error.data.name === "openerp.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
                this.show_warning({
                    ...
                    data: {message: _t("Your CubicERP session expired. Please refresh the current web page.")}
                });
                return;
            }
    ...
    instance.web.Menu = instance.web.Widget.extend({
        ...
        on_top_menu_click: function (ev) {
            ...
            if ($(ev.currentTarget).parent().hasClass('active')) {
                ...
                this.webclient.toggle_leftbar(true);
            }
        },
    ...
    instance.web.WebClient = instance.web.Client.extend({
        ...
        toggle_leftbar: function (force_open) {
            var self = this;
        ...
        apply_effect_to_leftbar: function () {
            ...
            $('.leftbar_opener').on('click', function () {
                self.toggle_leftbar()
            });
            $('.oe_menu_leaf, .oe_menu_leaf > .oe_menu_text').on('click', function () {
                self.toggle_leftbar()
            });
