...
(function () {
    ...
    openerp.web_graph.Graph = openerp.web.Widget.extend({
        ...
        display_as_selection: function (event) {
            event.preventDefault();
            event.stopPropagation();
        ...
        build_headers: function () {
            var pivot = this.pivot,
                ...
                height = _.max(_.map(pivot.cols.headers, function (g) {
        ...
        build_rows: function (headers, raw) {
            ...
            for (i = 0; i < nbr_of_rows; i++) {
                ...
                for (j = 0; j < col_headers.length; j++) {
                    ...
                    if (!values) {
                        values = new Array(pivot.measures.length);
                    }
        ...
        bar: function () {
            ...
            nv.addGraph(function () {
                ...
                chart.yAxis.tickFormat(function (d) {
                    return openerp.web.format_value(d, {type: 'float'});
                });
        ...
        line: function () {
            ...
            nv.addGraph(function () {
                ...
                chart.xAxis.tickFormat(function (d, u) {
                    return labels[d];
                });
